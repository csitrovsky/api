 ...
 *
 * This file includes the referenced bin path (../gam6itko/ozon-seller/bin/is_realized.php) using ob_start to remove the shebang if present
...
$binPath = __DIR__ . "/" . '../gam6itko/ozon-seller/bin/is_realized.php';
